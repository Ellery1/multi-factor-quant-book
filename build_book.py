...
CHAPTERS = [
    ...
    ("第一篇 · 认知篇", [
        (os.path.join(BOOK_DIR, "part1-认知篇", "第1章：什么是量化投资，从主观到量化的思维转变.md"),),
        (os.path.join(BOOK_DIR, "part1-认知篇", "第2章：多因子模型的前世今生，从CAPM到多因子.md"),),
    ]),
    ("第二篇 · 理论篇", [
        (os.path.join(BOOK_DIR, "part2-理论篇", "第3章：因子的本质：从直觉到严格定义.md"),),
        (os.path.join(BOOK_DIR, "part2-理论篇", "第4章：常见因子详解：经济逻辑与推导.md"),),
        (os.path.join(BOOK_DIR, "part2-理论篇", "第5章：因子检验方法论：统计推断的逻辑.md"),),
        (os.path.join(BOOK_DIR, "part2-理论篇", "第6章：因子合成与加权：最优性推导.md"),),
    ]),
    ("第三篇 · 工具与实践篇", [
        (os.path.join(BOOK_DIR, "part3-工具与实践篇", "第7章：数据获取与回测框架：从原始数据到可信的模拟交易.md"),),
        (os.path.join(BOOK_DIR, "part3-工具与实践篇", "第8章：A股多因子策略：从理论到实践的方法论路线图.md"),),
    ]),
    ("第四篇 · 进阶篇", [
        (os.path.join(BOOK_DIR, "part4-进阶篇", "第9章：风险管理与归因：理解你的收益从何而来.md"),),
        (os.path.join(BOOK_DIR, "part4-进阶篇", "第10章：过拟合与陷阱：量化研究中的常见错误.md"),),
        (os.path.join(BOOK_DIR, "part4-进阶篇", "第11章：从回测到实盘：现实世界的挑战.md"),),
        (os.path.join(BOOK_DIR, "part4-进阶篇", "第12章：前沿方向：机器学习与量化投资的未来.md"),),
    ]),
    ("附录", [
